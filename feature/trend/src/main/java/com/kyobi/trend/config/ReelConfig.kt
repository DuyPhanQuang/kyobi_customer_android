...
data class ReelConfig(
    ...
    val bufferMinMs: Int = 500, // Buffer tối thiểu của ExoPlayer
    val bufferMaxMs: Int = 1500, // Buffer tối đa của ExoPlayer
    val bufferPlaybackMs: Int = 500, // Buffer cho playback
    val bufferRebufferMs: Int = 500, // Buffer cho rebuffer
